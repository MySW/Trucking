...
@interface MainGestureRecognizerViewController ()<UIGestureRecognizerDelegate>
{
    CGPoint _startTouch;
...
@implementation MainGestureRecognizerViewController

static MainGestureRecognizerViewController *mainGRViewCtrl;
